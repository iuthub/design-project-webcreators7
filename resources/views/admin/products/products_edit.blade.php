...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Edit Product <a href="{{route('prod_list')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Back </a></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('prod_upd', ['id' => $product->id]) }}" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$product->name}}" id="product_name" name="product_name" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$product->desc}}" id="description" name="description" class="form-control col-md-7 col-xs-12">
